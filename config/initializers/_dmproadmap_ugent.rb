...
module DMPRoadmap
  ...
  class Application < Rails::Application
    ...
    config.x.organisation.name = "DMPBelgium Consortium"
    # Your organisation's abbreviation
    config.x.organisation.abbreviation = "DMPBelgium"
    ...
    config.x.organisation.copywrite_name = "DMPBelgium Consortium"
    # This email is used as the 'from' address for emails generated by the application
    config.x.organisation.email = "info@dmponline.be"
    # This email is used as the 'from' address for the feedback_complete email to users
    config.x.organisation.do_not_reply_email "info@dmponline.be"
    # This email is used in email communications
    config.x.organisation.helpdesk_email = "info@dmponline.be"
    ...
    # the address!
    config.x.organisation.google_maps_link = "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10033.888203917937!2d3.72439!3d51.044371!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x38c1d54789a9f6cb!2sUniversiteit%20Gent%20Universiteitsbibliotheek!5e0!3m2!1sen!2sbe!4v1608131228277!5m2!1sen!2sbe"
